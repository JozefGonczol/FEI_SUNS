...
def transform_labesl(labels, dict):
    newlabels = []
    for label in labels:
        lbl = dict[label]
...
dict = create_dict()
train_dataset, train_labels = reformat(train_dataset, train_labels, dict)
valid_dataset, valid_labels = reformat(valid_dataset, valid_labels, dict)
test_dataset, test_labels = reformat(test_dataset, test_labels, dict)
# print('Training set', train_dataset.shape, train_labels.shape)
# print('Validation set', valid_dataset.shape, valid_labels.shape)
# print('Test set', test_dataset.shape, test_labels.shape)
